    ...
    <main className="w-full bg-white">
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-10">
          ...
          <div className="space-y-2 text-[16px] leading-8 text-[#222]">
            ...
            <div className="pt-4">
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                ...
                <li>
                  assess whether you&apos;re truly ready to operate safely in
                  the air.
                </li>
              </ul>
            </div>
        ...
        <section className="mt-12">
          ...
          <div className="space-y-2 text-[16px] leading-8 text-[#222]">
            <p>
              This is where things get real — you&apos;ll finally be in the
              cockpit, logging actual flying hours. The DGCA mandates a minimum
              of 200 hours of total flight time to qualify for a{" "}
        ...
        <div className="space-y-12">
          <div>
            <h2 className="text-[34px] font-normal text-[#4a4a4a] mb-3 mt-4">
              Step 7: Get Licensed to Communicate
            </h2>
            <p className="text-gray-700 mb-6">
              Pilots communicate through highly standardised radio procedures.
              It's a language of its own, and you'll need to prove you've
              mastered it.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-3 text-gray-700 mb-6">
              ...
              <li>
                Then clear the DGCA-administered exam to obtain your Flight
                Radio Telephone Operator's License (FRTOL).
              </li>
            </ul>
          ...
          <div>
            <h2 className="text-[34px] font-normal text-[#4a4a4a] mb-3 mt-2">
              Step 8: Clear the CPL Skill Test
            </h2>
            <p className="text-gray-700">
              Now it's time to demonstrate everything you've learned in the air.
              A DGCA-approved flight examiner will accompany you on a test
              flight to assess your flying ability across a range of scenarios —
              including standard operations, navigation, and emergency handling
              procedures. Think of it as the equivalent of a driving test, but
              at 10,000 feet.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700 mb-6">
              You've done the hard work. Now it's time to make it official.
              Here's what you'll need to submit to the DGCA:
            </p>
            ...
            <p className="text-gray-700">
              Submit the complete set of documents to the DGCA and allow time
              for processing. Once approved, you'll receive your Commercial
              Pilot License — the credential that opens the door to a
          ...
          <div>
            ...
            <p className="text-gray-700 mb-6">
              With your CPL in hand, you're ready to enter the job market.
              Here's how to approach it:
            </p>

            <ul className="list-disc pl-6 space-y-3 text-gray-700">
              <li>
                Monitor job listings across domestic and international airlines
                regularly.
              </li>
              <li>
                Prepare thoroughly for airline entrance exams and interviews —
                each carrier runs its own selection process.
              </li>
              <li>
                If selected, you'll likely undergo Type Rating training, which
                qualifies you to fly the specific aircraft model operated by
                that airline.
              </li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto mt-4">
          ...
          <ul className="space-y-6 text-gray-700 text-[17px] leading-relaxed">
            <li className="flex gap-3">
              ...
              <span>
                <strong>Start saving early.</strong> Pilot training is one of
                the most expensive professional programs you can undertake.
                Financial planning from the outset makes a real difference.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              <span className="text-2xl leading-none text-gray-900">•</span>
              <span>
                <strong>Explore loan options.</strong> Many banks offer
                education loans tailored for aviation training if you need
                financial support.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              <span className="text-2xl leading-none text-gray-900">•</span>
              <span>
                <strong>Learn with depth, not shortcuts.</strong> Some
                institutes — often heavily promoted through social media — focus
                on helping students pass exams rather than building genuine
                understanding. This approach may get you through tests but will
                leave you underprepared for actual employment. Don't fall into
                that trap. Your career depends on your real competence, not your
                exam score.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              <span className="text-2xl leading-none text-gray-900">•</span>
              <span>
                <strong>Prioritise your health.</strong> Pilots are required to
                pass regular medical examinations throughout their careers.
                Staying physically fit is part of the job.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              <span className="text-2xl leading-none text-gray-900">•</span>
              <span>
                <strong>Stay current.</strong> Aviation evolves quickly. Keep up
                with industry developments, regulatory changes, and new
                technologies.
              </span>
            </li>
            ...
            <li className="flex gap-3">
              <span className="text-2xl leading-none text-gray-900">•</span>
              <span>
                <strong>Build your network.</strong> Connections with fellow
                pilots, instructors, and aviation professionals can open doors
                and offer guidance at every stage of your career.
              </span>
            </li>
          </ul>
        </div>
