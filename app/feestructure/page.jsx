    ...
    <div className="min-h-screen bg-[#f2f2f2] flex justify-center py-6 px-3">
      <div className="w-full max-w-360 overflow-hidden rounded-sm bg-white shadow-lg">
        ...
        <div className="relative h-112.5 w-full overflow-hidden">
          ...
          <div className="absolute inset-0 px-6 py-5 md:px-8">
            {/* Breadcrumb */}
            ...
            <div className="max-w-117.5">
              <h1 className=" font-serif">
                <span className="block text-[42px] font-bold text-white">
                  Commercial Pilot Training
                </span>

                <span className="block text-[42px] font-bold text-[#f4b32b]">
                  Fee Structure
                </span>
              </h1>

              <p className="mt-4 text-[16px] leading-7 text-[#d7d7d7] font-serif">
        ...
        <div className="grid grid-cols-1 gap-6 bg-[#f6f6f6] p-5 lg:grid-cols-[360px_1fr]">
          ...
          <div>
            ...
            <div className="rounded-md bg-white p-5 shadow-sm">
              <h2 className="text-[28px] font-bold text-[#0f2442] font-serif">
                About Our Training Program
              </h2>

              <div className="mt-3 h-[3px] w-16 bg-[#f4b32b]" />

              <p className="mt-4 text-[16px] leading-7 text-[#444] font-serif">
              ...
              {/* What's Included */}
              <h3 className="mt-8 text-[28px] font-bold text-[#0f2442] font-serif">
                What's Included
              </h3>
              ...
              <div className="mt-6 rounded-xl bg-[#eef3fb] p-5">
                <Quote
                  size={28}
                  className="mb-3 text-[#143c73]"
                />

                <p className="text-[16px] italic leading-7 text-[#4b4b4b] font-serif">
                  Our mission is to help aspiring pilots transform their dreams
                  into reality with the right guidance, training and industry
                  exposure.
                </p>

                <p className="mt-4 text-[16px] font-bold text-[#143c73] font-serif">
          ...
          <div>
            <div className="rounded-md bg-white p-5 shadow-sm">
              <h2 className="text-[32px] font-bold text-[#0f2442] font-serif">
                Transparent Milestone-Based Payment Structure
              </h2>

              <div className="mt-3 h-[3px] w-20 bg-[#f4b32b]" />

              <p className="mt-4 text-[18px] leading-7 text-[#444] font-serif">
                To ensure convenience and transparency, the training fees are
                divided into multiple stages based on the progress of training.
              </p>

              {/* TABLE */}
              <div className="mt-6 overflow-hidden rounded-lg border border-[#dcdcdc]">
                {/* Header */}
                <div className="grid grid-cols-[110px_1fr_150px] bg-[#082c59] text-white">
                  <div className="border-r border-[#284b76] px-4 py-4 text-center text-[14px] font-semibold font-serif">
                    Milestone
                  </div>

                  <div className="border-r border-[#284b76] px-4 py-4 text-[14px] font-semibold font-serif">
                    Particulars
                  </div>

                  <div className="px-4 py-4 text-center text-[14px] font-semibold font-serif">
                    Amount (₹)
                  </div>
                </div>
                ...
                {fees.map((item, index) => (
                  <div
                    key={index}
                    className="grid grid-cols-[110px_1fr_150px] border-t border-[#e5e5e5] bg-white"
                  >
                    <div className="flex items-center justify-center border-r border-[#e5e5e5] px-3 py-6 text-[24px] font-bold text-[#163c73]">
                      {item.no}
                    </div>

                    <div className="border-r border-[#e5e5e5] px-5 py-5">
                      <p className="whitespace-pre-line text-[16px] font-semibold leading-6 text-[#222] font-serif">
                        {item.particulars}
                      </p>

                      {item.sub && (
                        <p className="mt-1 text-[16px] italic text-[#666] font-serif">
                          {item.sub}
                        </p>
                      )}
                    </div>

                    <div className="flex items-center justify-center px-3 py-5 text-[18px] font-bold text-[#111]">
                      {item.amount}
                    </div>
                  </div>
                ))}
                ...
                {/* TOTAL */}
                <div className="grid grid-cols-[1fr_250px] bg-[#082c59]">
                  <div className="px-5 py-5 text-[24px] font-bold text-[#f4b32b] font-serif">
                    Total Course Fee
                  </div>

                  <div className="flex items-center justify-center border-l border-[#2d4c73] px-5 py-5 text-[32px] font-extrabold text-[#f4b32b] font-serif ">
                    ₹ 54,75,000
                  </div>
                </div>
              </div>
              ...
              <div className="mt-7 flex gap-5 rounded-xl border border-[#ead9a7] bg-[#fff8e9] p-5">
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-[#fff1c8] text-[#d89c12]">
                  <ClipboardCheck size={30} />
                </div>

                <div className="flex-1">
                  <h3 className="text-[22px] font-bold text-[#0f2442] font-serif">
                    Important Note
                  </h3>

                  <ul className="mt-3 space-y-2 text-[16px] leading-6 text-[#444] font-serif">
                    <li>
                    ...
                    <li>
                      ...
                      conditions, operational factors, and student performance.
                    </li>
        ...
        {/* CTA */}
        <div className="flex flex-col items-center justify-between gap-5 bg-[#082c59] px-8 py-6 md:flex-row">
          <div className="flex items-center gap-5">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#163c73] text-white">
              <PlaneTakeoff size={28} />
            </div>

            <div>
              <h3 className="text-[28px] font-bold text-white font-serif">
